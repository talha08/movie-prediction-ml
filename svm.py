...
print("Error margin for SVM: %0.2f" % (svm_error_margin/count*100))
...
final_pre = svm_clf.predict(encode([['Date With You', 'John August', 'Color', 'Jon Gunn', '43', '90', '16', '16', 'Brian Herzlinger', '86', '85222', 'Documentary', '4285', '163', 'Jon Gunn', '84', 'English', 'USA', '1100', '2004', '23', '456']]))
